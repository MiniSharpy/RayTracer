...
namespace RayTracer
{
	...
	{
		Pattern pattern = Pattern::Stripe(Colour::White, Colour::Black);
	...
	{
		Pattern pattern = Pattern::Stripe(Colour::White, Colour::Black);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(0,0,0)), Colour::White);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(0, 1, 0)), Colour::White);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(0, 2, 0)), Colour::White);
	}
	...
	TEST(PatternTest, StripeAtConstantZ)
	{
		Pattern pattern = Pattern::Stripe(Colour::White, Colour::Black);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(0, 0, 0)), Colour::White);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(0, 0, 1)), Colour::White);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(0, 0, 2)), Colour::White);
	}
	...
	TEST(PatternTest, StripeAtAlternatingX)
	{
		Pattern pattern = Pattern::Stripe(Colour::White, Colour::Black);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(0, 0, 0)), Colour::White);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(0.9, 0, 0)), Colour::White);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(1, 0, 0)), Colour::Black);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(-0.1, 0, 0)), Colour::Black);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(-1, 0, 0)), Colour::Black);
		ASSERT_EQ(Pattern::StripeAt(pattern, Tuple::Point(-1.1, 0, 0)), Colour::White);
	}
	...
	TEST(PatternTest, StripesWithObjectTransform)
	{
		...
		sphere.Material_.Pattern_ = Pattern::Stripe(Colour::White, Colour::Black);
